                    ...
                    <div class="card-body">
                        <ul class="nav nav-tabs separator-tabs ml-0 mb-5" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link " id="third-tab" data-toggle="tab" href="#third" role="tab"
                                    aria-controls="third" aria-selected="false">AVATAR</a>
                            </li>
                        </ul> 
                        ...
                        <div class="tab-content">
                            <div class="tab-pane show active" id="first" role="tabpanel" aria-labelledby="first-tab">
                                ...
                                <small class="mt-5">*) harus diisi.</small>
                            ...
                            <div class="tab-pane fade" id="second" role="tabpanel" aria-labelledby="second-tab">
                                ...
                                <label class="form-group has-float-label">
                                    <select class="form-control select2-single" name="districts" id="districts">
                                        <option value="0" disable="true"></option>
                                    </select>
                                    <span>Kecamatan</span>
                                ...
                                <label class="form-group has-float-label">
                                    <textarea class="form-control select2-single" name="address" rows="3" maxlength="190">{{$user->address}}</textarea>
